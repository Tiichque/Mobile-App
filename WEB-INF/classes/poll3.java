...
@WebServlet("/poll3")   // Configure the request URL for this servlet (Tomcat 7/Servlet 3.0 upwards)
public class poll3 extends HttpServlet {
   ...
   public void doGet(HttpServletRequest request, HttpServletResponse response)
      ...
      // Print an HTML page as the output of the query
        out.println("<html>");
        out.println("<head>");
        out.println("<title>Question 3</title>");
        out.println("</head>");
        out.println("<body>");
        out.println("<div>");
      ...
      try (
       ...
       String poll = "SELECT choice, COUNT(*) FROM response WHERE questionNo = 3 GROUP BY choice";
        ...
        out.println("var barColors = ['blue', 'red','red','red'];");
        out.println("new Chart('myChart', { type: 'bar', data: { labels: xValues, datasets: [{ backgroundColor: barColors, data: yValues }] },");
        out.println("options: { legend: {display: false}, title: { display: true, text: 'Question 3'} } }); </script></body>");
        out.println("<a href='index.html'>End review</a><br><br>");
