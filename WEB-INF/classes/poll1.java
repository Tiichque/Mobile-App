...
@WebServlet("/poll1")   // Configure the request URL for this servlet (Tomcat 7/Servlet 3.0 upwards)
public class poll1 extends HttpServlet {
   ...
   public void doGet(HttpServletRequest request, HttpServletResponse response)
      ...
      try (
       ...
       String poll = "SELECT choice, COUNT(*) FROM response WHERE questionNo = 1 GROUP BY choice";
        ...
        out.println("var barColors = ['red', 'blue','red','red'];");
        out.println("new Chart('myChart', { type: 'bar', data: { labels: xValues, datasets: [{ backgroundColor: barColors, data: yValues }] },");
        out.println("options: { legend: {display: false}, title: { display: true, text: 'Question 1'} } }); </script></body>");
        out.println("<a href='/clicker/poll2'>Continue to review </a><br><br>");
